...
class Standardizer {
    ...
    companion object {
        ...
        fun standardize(adr: String) : Map<String, String> {
            ...
            val model = ModelFactory.load(country)
            ...
            var (primaryAddressNumber, preDirection, streetName, suffix, postDirection) = findStreet(splitted, model);
         ...
         *
         * @param adr Address without city, state, and zip
         * @param city City
         * @param state State
         * @param zip Zipcode
         * @return A map with all the data
         */
        @JvmStatic
        fun standardize(adr: String, city: String, state: String, zip: String) : Map<String, String> {
            var newAdr = adr.replace(".", "")
            newAdr = newAdr.uppercase()
            var splitted = newAdr.split(' ')

            val model = ModelFactory.load("us")
            ...
            return hashMapOf(
                "zipcode" to findZipCode(listOf(zip.uppercase()))["returned"].toString(),
